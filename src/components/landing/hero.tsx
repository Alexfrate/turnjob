        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/50 dark:bg-neutral-900/50 backdrop-blur-sm border border-neutral-200 dark:border-neutral-800">
              ...
              <div className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">{t('hero.social.companies')}</div>
            </div>
            <div className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/50 dark:bg-neutral-900/50 backdrop-blur-sm border border-neutral-200 dark:border-neutral-800">
              <Calendar className="h-8 w-8 text-primary-600 dark:text-primary-400" />
              <div className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">{t('hero.social.shifts')}</div>
            </div>
            <div className="flex flex-col items-center gap-2 p-4 rounded-xl bg-white/50 dark:bg-neutral-900/50 backdrop-blur-sm border border-neutral-200 dark:border-neutral-800">
              <TrendingUp className="h-8 w-8 text-primary-600 dark:text-primary-400" />
              <div className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">{t('hero.social.satisfaction')}</div>
            </div>
          </div>
        </div>
      </div>
