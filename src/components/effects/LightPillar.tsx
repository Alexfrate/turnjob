...
const LightPillar = ({
  ...
  useEffect(() => {
    ...
    // Shader ottimizzato con meno iterazioni
    const fragmentShader = `
      ...
      void main() {
        ...
        // Ridotto da 100 a 50 iterazioni
    ...
    // Intersection Observer per pausa quando non visibile
    ...
    // Animation loop - ridotto a 30 FPS
